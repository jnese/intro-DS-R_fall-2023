...
5.  How many popcorn kernels are in the jar?
...
3.  **Tools 🡆 Global Options 🡆 Pane Layout**

- As you like

4.  **Tools 🡆 Global Options 🡆 Appearance**
...
-   Let's take a `glimpse` the `gss_cat` data frame which loads with `tidyverse`
